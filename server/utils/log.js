 ...
 * @param {import('pg').PoolClient} [client] - 可选事务客户端，不传则用 pool
 */
export async function writeLog(tableName, { operation, recordId, fieldName, oldValue, newValue, userId, userName }, client) {
  try {
